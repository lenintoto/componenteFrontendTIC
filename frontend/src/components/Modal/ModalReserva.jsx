...
export const ModalVehiculo = ({}) => {
  ...
  <div className="bg-white p-6 rounded-lg shadow-lg w-1/2">
    <h2 className="text-lg font-bold mb-4">Agregar Auditorio</h2>
    <form>
      <div>
      ...
      <div className="flex justify-between">
        <button type="submit" className="bg-gray-600 text-slate-300 uppercase font-bold rounded-lg p-2 hover:bg-gray-900 transition-all">
          Agregar
        </button>
        <button type="button" className="bg-red-500 text-white uppercase font-bold rounded-lg p-2 hover:bg-red-700 transition-all">
          Cancelar
        </button>
      </div>
    </form>
